...
public class SearchRecyclerViewAdapter extends XRVAdapter<DataEntity.DataBean> {
    public SearchRecyclerViewAdapter(Context context, List<DataEntity.DataBean> list, int... layoutIds) {
        super(context, list, layoutIds);
    }

    @Override
    protected void onBindData(XRVHolder viewHolder, final int position, DataEntity.DataBean item) {
