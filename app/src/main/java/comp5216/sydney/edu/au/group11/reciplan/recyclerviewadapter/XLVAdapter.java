...
public abstract class XLVAdapter<T> extends BaseAdapter implements DataHelper<T> {
    ...
    public XLVAdapter(Context context, List<T> list, int... layoutIds) {
    ...
    public XLVAdapter(Context context, List<T> list) {
        this.mContext = context;
        this.mList = list;
        this.mLInflater = LayoutInflater.from(mContext);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        XLVHolder holder = XLVHolder.get(mContext, position, convertView, parent, layoutId, getImageLoader());
    ...
    public abstract void convert(XLVHolder holder, int position, T t);
